...
import com.android.xlwlibrary.helper.XColorHelper;
...
public class XSwitchButton extends CompoundButton {
	...
	private void init(AttributeSet attrs) {
		...
		if (!mIsThumbUseDrawable && mThumbColor == null) {
			mThumbColor = XColorHelper.generateThumbColorWithTintColor(mTintColor);
		...
		if (!mIsBackUseDrawable && mBackColor == null) {
			mBackColor = XColorHelper.generateBackColorWithTintColor(mTintColor);
