 ...
 *
 */
public class XTextBannerView extends RelativeLayout {
    ...
    @AnimRes
    private int inAnimResId = R.anim.animba_right_in;
    @AnimRes
    private int outAnimResId = R.anim.animba_left_out;
        ...
        if (hasSetDirection) {
            switch (direction) {
                case DIRECTION_BOTTOM_TO_TOP:
                    inAnimResId = R.anim.animba_bottom_in;
                    outAnimResId = R.anim.animba_top_out;
                    break;
                case DIRECTION_TOP_TO_BOTTOM:
                    inAnimResId = R.anim.animba_top_in;
                    outAnimResId = R.anim.animba_bottom_out;
                    break;
                case DIRECTION_RIGHT_TO_LEFT:
                    inAnimResId = R.anim.animba_right_in;
                    outAnimResId = R.anim.animba_left_out;
                    break;
                case DIRECTION_LEFT_TO_RIGHT:
                    inAnimResId = R.anim.animba_left_in;
                    outAnimResId = R.anim.animba_right_out;
                    break;
            }
        } else {
            inAnimResId = R.anim.animba_right_in;
