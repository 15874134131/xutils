...
public class WaveView extends View {
    ...
    private float wAmplitude = 1.2f;

    private int[] COLORS = {R.color.bull_title, R.color.bar_text, R.color.approve_tv};
