package com.android.xlwlibrary.nestfulllist;
...
public class NestFullViewHolder {
    ...
    public NestFullViewHolder setText(TextView myTextView, String text) {
        myTextView.setText(text);
        return this;
    }

    public NestFullViewHolder setEditext(int viewId, String text) {
        EditText tv = getView(viewId);
        tv.setHint(text);
        return this;
    }

    public NestFullViewHolder setTextSpannable(int viewId, SpannableStringBuilder text) {
        TextView tv = getView(viewId);
        tv.setText(text);
        return this;
    }
    ...
    public NestFullViewHolder setTextSpannableMy(TextView myTextView, SpannableStringBuilder text) {
        myTextView.setText(text);
        return this;
    }
